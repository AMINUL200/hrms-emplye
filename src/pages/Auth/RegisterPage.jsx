                ...
                <div className="reg-main-right pt-0">
                  ...
                  <form action="" className="acc-body">
                    ...
                    <div className="input-block-check mb-2">
                      <input
                        type="checkbox"
                        id="terms-conditions1"
                        name="terms-conditions"
                        required
                      />
                      <label for="terms-conditions">
                        I confirm that I have read the Privacy Policy and I
                        agree to the website Terms of Use and License Agreement
                      </label>
                    </div>
                    {/* checkbox */}
                    <div className="input-block-check mb-2">
                      <input
                        type="checkbox"
                        id="terms-conditions2"
                        name="terms-conditions"
                        required
                      />
                      <label for="terms-conditions">
                        I understand that they do not, in any way, replace
                        immigration advice
                      </label>
                    </div>
                    {/* submit button */}
