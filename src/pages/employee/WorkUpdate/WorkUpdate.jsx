import { faEllipsisVertical, faFile, faFileExcel, faFilePdf, faPencil, faPlus, faTrashCan, faSearch, faFilter, faRefresh } from '@fortawesome/free-solid-svg-icons';
                        ...
                        <div className="card-body px-0 pb-0">
                                ...
                                <table className="table table-hover align-middle mb-0 d-none d-md-table">
                                    <thead className="table-infoo">
                                        <tr>
                                            ...
                                            <th className="text-center text-gray border py-3">Date</th>
                                            <th className="text-center text-gray border py-3">From Time</th>
                                            <th className="text-center text-gray border py-3">To Time</th>
                                            <th className="text-center text-gray border py-3">Time</th>
                                            <th className="text-center text-gray border py-3">Work Report</th>
                                            <th className="text-center text-gray border py-3">Comment</th>
                                        ...
                                        {currentWorkUpdate.length > 0 ? (
                                            currentWorkUpdate.map((item, index) => (
                                                <tr key={item.id}>
                                                    ...
                                                    <td className="fw-semibold text-gray border">{item.time}</td>
                                                ...
                                                <div className="card-body">
                                                    ...
                                                    <div className="row mb-2">
                                                        <div className="col-6">
                                                            ...
                                                            <p className="mb-0 fw-semibold text-gray">{item.from}</p>
                                                        </div>
                                                        <div className="col-6">
                                                            <p className="mb-1 small text-muted">To</p>
                                                            <p className="mb-0 fw-semibold text-gray">{item.to}</p>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div className="row mb-2">
                                                        <div className="col-6">
                                                            ...
                                                            <p className="mb-0 fw-semibold text-gray">{item.time}</p>
                                                        </div>
                                                    </div>
                                                    
                                                    <div className="row mb-2">
                                                        <div className="col-12">
                                                            <p className="mb-1 small text-muted">Work Report</p>
                                                            {item.remarks && item.remarks.length > 50 ? (
                                                                ...
                                                                <p className="mb-0 text-gray">{item.remarks || 'No remarks'}</p>
                                                            )}
                                                        </div>
                                                    </div>
                            ...
                            <div className="d-flex flex-column flex-md-row justify-content-between align-items-center px-3 px-md-4 py-3 border-top">
                                <div className="text-muted mb-2 mb-md-0">
                                    Showing {startIndex + 1} to {Math.min(endIndex, filteredWorkUpdate.length)} of {filteredWorkUpdate.length} entries
                                </div>
